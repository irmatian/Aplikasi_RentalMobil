			...
			<div class="card-body">
				<form method="POST" action="<?php echo base_url('admin/transaksi/cek_pembayaran') ?>">
					...
					<?php foreach($pembayaran as $pmb) : ?>
						...
						<a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/transaksi/download_pembayaran/'.$pmb->id_rental) ?>"><i class="fas fa-download"></i> Download Bukti Pembayaran</a>
